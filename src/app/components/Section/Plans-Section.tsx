    ...
    <section className="bg-[#F8FBFF] ">
      ...
      <div className=" max-md:flex flex max-md:flex-col flex-wrap md:flex max-md:gap-[16px]  items-start justify-around">
        ...
        {gotPlansData.map((plan) => (
          <div
            key={plan.planName}
            className={`p-4 flex m-3 mx-auto group  relative flex-col gap-[10px] max-md:w-[335px] md:w-[360px] mt-[25px] md:mt-0 hover:bg-yellow-400 hover:border-[ #007AFF] border-[1px] rounded-md shadow-[0px_0px_10px_rgba(104,104,104,0.08)] animation cursor-pointer md:block transition delay-150 duration-500 ${
            ...
            <div className="md:min-h-[95px]">
              ...
              <div className="flex flex-row pb-[16px] items-center ">
                <p className="text-[18px] text-[#8095A7] group-hover:text-gray-700 duration-500 font-medium">
                  {plan.plan.laterPaid.ammount} {plan.plan.laterPaid.text}
                </p>
                <div
