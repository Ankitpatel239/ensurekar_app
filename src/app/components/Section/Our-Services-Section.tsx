    ...
    Service_options: [
      {
        ...
        subServices: [
          ...
          },
          {
            ...
            plan_type: "month",
            know_more: "/limited-liability-partnership",
          },
          {
        ...
        subServices: [
          {
            ...
            tax: "Government fees + applicable taxes and charges extra",
            plan_type: undefined,
            know_more: "/trademark-registrations",
            description: [
      ...
      },
      {
        ...
        subServices: [
          ...
          },
          {
            ...
            paymentIcon: "",
            plan_type: undefined,
            know_more: "/professional-tax-registration-",
            description: [
                              ...
                              {service.price ? (
                                <>
                                  ...
                                  <div className="text-5xl flex justify-center leading-none font-semibold">
                                    <span className="text-3xl mr-[3px]">₹</span>
                                    {service.price}
                                  </div>
                                </>
                              ) : (
                                <p className="text-sm pb-1">{service.priceNote}</p>
                              )}

                              <p className="text-sm">{service.tax}</p>
                            </div>
                          </div>
                              {service.description && service.description.length === 1 }
                          <ul className={`${(service.description && service.description.length != 1)?"list-disc":'' } flex flex-col p-3 flex-wrap content-center items-cente`}>
