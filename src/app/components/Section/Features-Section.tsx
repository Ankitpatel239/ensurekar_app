    ...
    <section className="bg-softBg1 stp-30 sbp-30">
      <div className="container">
        <div className="flex justify-between items-end gap-6 max-lg:flex-col max-lg:items-start">
          ...
          Let EnsureKar handle the complexities, so you can focus on what matters most. 
          </p>
        </div>
        <div className="grid grid-cols-12 gap-6 stp-15">
          ...
          >
            <div className="bg-white min-h-[320px] flex flex-col justify-between p-6 xl:p-8 flex flex-col border border-white group hover:border-mainTextColor duration-700 hover:bg-s2">
