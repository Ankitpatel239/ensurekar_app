...
const LimitedLiabilityPartnershipRegistration = () => {
  ...
  const RegisterStepsData = {
    ...
    aboutSteps: [
      ...
      },
      {
        ...
        description:
          "Our team will assist you with obtaining the Digital Signature Certificate (DSC), reserving your company name, and drafting the necessary incorporation forms.",
      },
      {
        title: "Get Your Certificate",
        description:
          "After filing with the MCA, receive your LLP or company incorporation certificate within the designated time, along with your PAN, TAN, and other required documents.",
      },
    ],
  ...
  const AllInOneData = {
    ...
    description: [
      ...
      " A partnership firm is where two or more persons come together to establish a business and divide its profits amongst themselves in the agreed ratio. The partnership business includes any kind of trade, occupation and profession.",
    ],
  };
  const OverviewData = {
    heading: "Limited Liability Partnership Registration ",
        ...
        requiredSteps: [
          {
            ...
            steps: [
              ...
              {
                heading: "",
                description: "Has a Distinct Legal Identity from Partners",
              },
              {
                heading: "",
              ...
              },
              {
                heading: "",
                description:
                  "Change in partners does not affect LLP's existence",
              },
            ],
          },
        ],
  ...
  const FAQsData = {
    ...
    FAQs: [
      ...
      {
        question: "How does an LLP differ from an LLC?",
        answer: "NA",
      },
      {
